...
$(OBJ_DIR)/convert.o: convert.c convert.h | obj_dir
	$(CXX) $(CFLAGS) -c $< -o $@

$(OBJ_DIR)/embed.o: embed.c embed.h grouping.h convert.h | obj_dir
	$(CXX) $(CFLAGS) -c $< -o $@

$(OBJ_DIR)/grouping.o: grouping.c grouping.h | obj_dir
	$(CXX) $(CFLAGS) -c $< -o $@

$(OBJ_DIR)/decoder.o: decoder.c decoder.h convert.h | obj_dir
	$(CXX) $(CFLAGS) -c $< -o $@
